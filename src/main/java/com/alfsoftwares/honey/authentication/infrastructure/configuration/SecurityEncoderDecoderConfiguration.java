...
public class SecurityEncoderDecoderConfiguration {
    ...
    public RSAPrivateKey rsaPrivateKey() throws Exception {
        String key = new String(new ClassPathResource("certs/private_key.pem").getInputStream().readAllBytes());
    ...
    public RSAPublicKey rsaPublicKey() throws Exception {
        String key = new String(new ClassPathResource("certs/public_key.pem").getInputStream().readAllBytes());
